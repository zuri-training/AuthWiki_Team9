...
import { TestimonialCSS } from "../css/TestimonialCSS.js";
import pic1 from "../images/icons/pic1";
        ...
        <div className="testimonial_container">
            <div className="testimonial_box">
                <div className="testimonial_title">
                    <span><img className="testimonial_image" src={pic1} alt="pic1"/></span>
                    ...
                    <span>
                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="#A9A9A5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </span>
                </div>
                <div className="testimonial_content">
                    <p>Will @AuthIt please just right now setup <br></br>
            ...
            <div className="testimonial_box">
                <div className="testimonial_title">
                    <span><img className="testimonial_image" src={pic2} alt="pic2"/></span>
            ...
            <div className="testimonial_box">
                <div className="testimonial_title">
                    <span><img className="testimonial_image" src={pic3} alt="pic3"/></span>
